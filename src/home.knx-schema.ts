...
export const lights = {
    "Oswietlenie.Salon i lazienka.Salon i lazienka Swiatla Off": { address: "14/0/0", dataType: DPT_Switch },
    "Oswietlenie.Jadalnia.Jadalnia LED A On/Off": { address: "14/2/1", dataType: DPT_Switch },
    "Oswietlenie.Jadalnia.Jadalnia LED A On/Off Stan": { address: "14/2/2", dataType: DPT_Switch },
    "Oswietlenie.Jadalnia.Jadalnia LED B On/Off": { address: "14/2/6", dataType: DPT_Switch },
    "Oswietlenie.Jadalnia.Jadalnia LED B On/Off Stan": { address: "14/2/7", dataType: DPT_Switch },
    "Oswietlenie.Kuchnia.Cala Kuchnia LED On/Off": { address: "14/3/1", dataType: DPT_Switch },
    "Oswietlenie.Kuchnia.Cala Kuchnia LED On/Off Stan": { address: "14/3/2", dataType: DPT_Switch },
    "Oswietlenie.Kuchnia.Kuchnia LED A On/Off": { address: "14/3/6", dataType: DPT_Switch },
    "Oswietlenie.Kuchnia.Kuchnia LED A On/Off Stan": { address: "14/3/7", dataType: DPT_Switch },
    "Oswietlenie.Kuchnia.Kuchnia LED B On/Off": { address: "14/3/8", dataType: DPT_Switch },
    "Oswietlenie.Kuchnia.Kuchnia LED B On/Off Stan": { address: "14/3/9", dataType: DPT_Switch },
    "Oswietlenie.Lazienka.Lazienka LED Main On/Off": { address: "14/4/2", dataType: DPT_Switch },
    "Oswietlenie.Lazienka.Lazienka LED Lustro On/Off": { address: "14/4/5", dataType: DPT_Switch },
    "Oswietlenie.Lazienka.Lazienka LED Geberit on/off": { address: "14/4/8", dataType: DPT_Switch },
    "Oswietlenie.Lazienka.Lazienka LED Shower on/off": { address: "14/4/9", dataType: DPT_Switch },
    "Oswietlenie.Lazienka.Lazienka LED Geberit Stan": { address: "14/4/10", dataType: DPT_Switch },
    "Oswietlenie.Lazienka.Lazienka LED Shower Stan": { address: "14/4/11", dataType: DPT_Switch },
    "Oswietlenie.Hol.Salon Hol LED On/Off": { address: "14/5/2", dataType: DPT_Switch },
    "Oswietlenie.Hol.Sypialnia LED hol i schowek On/Off": { address: "14/5/7", dataType: DPT_Switch },
    "Oswietlenie.Hol.Sypialnia LED hol i schowe stan on/off": { address: "14/5/8", dataType: DPT_Switch },
    "Oswietlenie.Hol.Sypialnia LED Hol On/Off": { address: "14/5/9", dataType: DPT_Switch },
    "Oswietlenie.Hol.Sypialnia LED Hol On/Off Stan": { address: "14/5/10", dataType: DPT_Switch },
    "Oswietlenie.Salon.Caly Salon LED On/Off": { address: "14/6/4", dataType: DPT_Switch },
    "Oswietlenie.Salon.Caly Salon LED On/Off Stan": { address: "14/6/5", dataType: DPT_Switch },
    "Oswietlenie.Salon.Salon LED A On/Off": { address: "14/6/9", dataType: DPT_Switch },
    "Oswietlenie.Salon.Salon LED A On/Off Stan": { address: "14/6/10", dataType: DPT_Switch },
    "Oswietlenie.Salon.Salon LED B On/Off": { address: "14/6/11", dataType: DPT_Switch },
    "Oswietlenie.Salon.Salon LED B On/Off Stan": { address: "14/6/12", dataType: DPT_Switch },
    "Oswietlenie.Sypialnia.Sypialnia LED B On/Off": { address: "14/7/3", dataType: DPT_Switch },
    "Oswietlenie.Sypialnia.Sypialnia LED B On/Off Stan": { address: "14/7/4", dataType: DPT_Switch },
    "Oswietlenie.Sypialnia.Sypialnia LED A On/Off": { address: "14/7/8", dataType: DPT_Switch },
    "Oswietlenie 230V.Parkiet.Parkiet Swiatlo on/off": { address: "12/0/0", dataType: DPT_Switch },
    "Oswietlenie 230V.Parkiet.Parkiet Swiatlo Stan": { address: "12/0/1", dataType: DPT_Switch },
    "Oswietlenie.Hol.Salon Hol LED On/Off Stan": { address: "14/5/3", dataType: DPT_Switch },
    "Oswietlenie.Sypialnia.Sypialnia LED A On/Off Stan": { address: "14/7/9", dataType: DPT_Switch },
}
...
export const energy = {
    "EnergyMeter.RequestReadings": { address: "5/0/0" },
    "EnergyMeter.InstanPowerUsage": { address: "5/0/1", dataType: DPT_Value_Power },
    "EnergyMeter.Frequency": { address: "5/1/0" },
    "Energy Management.Energy.Request Energy Readings": { address: "5/2/0" },
    "Energy Management.Energy.Start": { address: "5/2/1", dataType: DPT_Start },
    "Energy Management.Energy.Intermediate Reading": { address: "5/2/2" },
    "Energy Management.Energy.Total Energy Reading": { address: "5/2/3" },
    "Energy Management.Energy.Stop": { address: "5/2/4", dataType: DPT_Start },
    "Energy Management.Energy.Status": { address: "5/2/5" },
}

export const sensors = {
    "Ogrzewanie.Podloga lazienka.Podloga lazienka temperatura": { address: "13/0/2", dataType: DPT_Value_Temp },
    "Sensory.Powietrze.Tempertura Salon": { address: "15/0/0" },
    "Sensory.Powietrze.Temperatura lazienka": { address: "15/0/1", dataType: DPT_Value_Temp },
    "Sensory.Powietrze.Temperatura sypialnia przy loggi": { address: "15/0/2" },
    "Sensory.Powietrze.Zawartosc CO2 ppm": { address: "15/0/3", dataType: DPT_Value_AirQuality },
    "Sensory.Powietrze.Temperatura sypialnia sufit": { address: "15/0/4" },
    "Sensory.Powietrze.Wilgotnosc powietrza": { address: "15/0/5", dataType: DPT_Value_Humidity },
    "Sensory.Powietrze.Temperatura sypialnia lozko lewa": { address: "15/0/6" },
    "Sensory.Powietrze.Temperatura sypialnia sofa": { address: "15/0/7", dataType: DPT_Value_Temp },
...
export const venting = {
    ...
    "Oswietlenie.Sypialnia.Sypialnia smiglo on/off": { address: "14/7/15", dataType: DPT_Switch },
    "Oswietlenie.Sypialnia.Sypialnia smiglo status": { address: "14/7/16", dataType: DPT_Switch },
